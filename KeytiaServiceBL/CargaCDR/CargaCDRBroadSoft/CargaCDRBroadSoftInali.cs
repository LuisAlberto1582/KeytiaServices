...
{
    public class CargaCDRBroadSoftInali : CargaCDRBroadSoft
    {
        public CargaCDRBroadSoftInali()
        {
            piColumnas = 8;
        ...
        protected override int IdentificaCriterio(string lsExt, string lsDigitos)
        {
            ...
            else if ((lsExt.Length >= 3 && lsDigitos.Length == 3) || (lsExt.Length >= 4 && lsDigitos.Length == 4) || (lsExt.Length == 5 && lsDigitos.Length == 5))
            {
                liCriterio = 2;   // Enlace
            }
