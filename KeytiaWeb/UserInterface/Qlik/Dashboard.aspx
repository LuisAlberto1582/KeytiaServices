<%@ Page Title="" Language="C#" MasterPageFile="~/KeytiaOH.Master" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="KeytiaWeb.UserInterface.Qlik.Dashboard" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphContent" runat="server">
    ...
    <div id="main" style="width: 100%; height: 100%">
        <%--Reportes--%>
        <asp:PlaceHolder runat="server" ID="replaceHTML"></asp:PlaceHolder>
    </div>
