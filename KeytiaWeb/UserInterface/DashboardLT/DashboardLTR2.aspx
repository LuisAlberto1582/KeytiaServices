<%@ Page Language="C#" MasterPageFile="~/KeytiaOH.Master" AutoEventWireup="true" CodeBehind="DashboardLTR2.aspx.cs" Inherits="KeytiaWeb.UserInterface.DashboardLT.DashboardLTR2" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphContent" runat="server">
    ...
    <div>
        <div>
            <div align="left" style="height: 24px">
                <asp:Label ID="lblInicio" runat="server" CssClass="tituloInicio"></asp:Label>
            </div>
        </div>
        <div>
            <asp:Panel ID="pToolBar" runat="server" CssClass="fg-toolbar ui-toolbar ui-widget-header ui-corner-tl ui-corner-tr ui-helper-clearfix ">
                <asp:Button ID="btnRegresar" runat="server" CssClass="buttonBack" OnClick="btnRegresar_Click"
                    Text="< Regresar" />
                &nbsp;
                <asp:Button ID="btnAplicar" runat="server" CssClass="buttonPlay noRepeat" OnClick="btnAplicar_Click"
                    Text="Aplicar"></asp:Button>
            </asp:Panel>
            <div>
    ...
    <asp:Panel ID="pnlContenedorPrincipal" runat="server" HorizontalAlign="Center" Width="100%" ScrollBars="Auto">
    </asp:Panel>
</asp:Content>
