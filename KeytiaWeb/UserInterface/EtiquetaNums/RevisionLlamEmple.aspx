<%@ Page Title="" Language="C#" MasterPageFile="~/KeytiaOH.Master" AutoEventWireup="true" CodeBehind="RevisionLlamEmple.aspx.cs" Inherits="KeytiaWeb.UserInterface.EtiquetaNums.RevisionLlamEmple" %>
                ...
                <div class="portlet-title">
                    <div class="caption">
                        <i class="icon-bar-chart font-dark hide"></i>
                            <span class="caption-subject titlePortletKeytia" id="labelMensaje" runat="server">Revisión de llamadas por empleado</span>
                    </div>
                    <div class="actions">
                    ...
                    <div class="collapse in form-horizontal" id="RepDetallCollapse" role="form" >
                                    ...
                                    <div class="panel-heading">
                                       ...
                                       <div class="row">
                                           ...
                                           <div class="col-sm-12">
                                               ...
                                               <div class="col-sm-2">
                                                    <asp:Panel ID="rowExportar" runat="server" CssClass="form-group" Visible="false">
                                                        <div class="col-sm-offset-2 col-sm-2">
                                                            <asp:Button runat="server" id="btnExportar" CssClass="btn btn-keytia-lg" text="Exportar" OnClick="btnExportar_Click"/>
                                                        </div>               
                                                    </asp:Panel>
                                               </div>
                                           </div>
                                        ...
                                        <div id="DivllamLocales" runat="server">
                                            <asp:GridView runat="server" ID="grdLlamLocales" AutoGenerateColumns="false" HeaderStyle-CssClass="tableHeaderStyle" CssClass="table table-bordered tableDashboard">
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField= "Cantidad" HeaderText="" HeaderStyle-Font-Size="Small" ItemStyle-Font-Size="Small"/>
                        ...
                        <div class="row" runat="server" id="Div2" visible="false">
                            <div class="col-sm-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <p id="p1" runat="server" style="text-align:center;font-weight:bold;"></p>
                                    </div>
                                    <div class="panel-body">                                        
                                        <div id="Div3" runat="server">
                                            <asp:GridView runat="server" ID="GridView1" AutoGenerateColumns="false" HeaderStyle-CssClass="tableHeaderStyle" CssClass="table table-bordered tableDashboard"
                                        ...
                                        <div>
                                            <asp:GridView runat="server" ID="GridView2" AutoGenerateColumns="false" ShowHeader="false" CssClass="table table-bordered lastRowTable tableFooter">
                                                <Columns>
                                                    <asp:BoundField DataField = "Llamadas"/>
                                                    <asp:BoundField DataField = "Minutos"/>
                                                    <asp:BoundField DataField = "CostoTotal"/>
                                    ...
                                    <div class="panel-footer" runat="server" id="Div4">
                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <div class="col-sm-12">
                                            <div class="row">
                                                <div class="table-fixed-nz" runat="server" id="LlamadasDiv">
                                                    <asp:GridView runat="server" ID="grvLlamadas" AutoGenerateColumns="false" HeaderStyle-CssClass="tableHeaderStyle" CssClass="table table-bordered tableDashboard"
                                                        ...
                                                        <Columns>
                                                            <asp:BoundField DataField="CobroLlam" HeaderText="Negocio" HeaderStyle-Font-Size="Small" ItemStyle-Font-Size="Small"/>
                                                            <asp:BoundField DataField= "Extension"  HeaderText="Ext." HeaderStyle-Font-Size="Small" ItemStyle-Font-Size="Small"/>
...
<%--                                                            <asp:TemplateField HeaderText="Referencia" HeaderStyle-Font-Size="Small" ItemStyle-Font-Size="Small">
                                        ...
                                        <div class="table-fixed-nz">
                                                    <asp:GridView runat="server" ID="grdMovil" AutoGenerateColumns="false" HeaderStyle-CssClass="tableHeaderStyle" CssClass="table table-bordered tableDashboard"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:BoundField DataField= "Extension"  HeaderText="Ext." HeaderStyle-Font-Size="Small" ItemStyle-Font-Size="Small"/>
                                                            <asp:BoundField DataField= "NumMarcado" HeaderText="Número" HeaderStyle-Font-Size="Small" ItemStyle-Font-Size="Small"/>
                                                            <asp:BoundField DataField= "numero" HeaderText="" HeaderStyle-Font-Size="Small" ItemStyle-Font-Size="Small"/>
                                                            <asp:BoundField DataField= "Duracion" HeaderText="Duración (minutos)" HeaderStyle-Font-Size="Small" ItemStyle-Font-Size="Small"/>
                                                           <asp:BoundField DataField="Localidad" HeaderText="Referencia" HeaderStyle-Font-Size="Small" ItemStyle-Font-Size="Small"/>
                                                             <%--<asp:TemplateField HeaderText="Referencia" HeaderStyle-Font-Size="Small" ItemStyle-Font-Size="Small">
                                                                <ItemTemplate>
                        ...
                        <div class="row" id="row5" runat="server" visible="false">
                            <div class="col-sm-12">
                                <div class="panel panel-default">
