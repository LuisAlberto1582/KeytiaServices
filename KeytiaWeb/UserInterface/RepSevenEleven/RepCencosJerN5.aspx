<%@ Page Title="" Language="C#" MasterPageFile="~/KeytiaOH.Master" AutoEventWireup="true" CodeBehind="RepCencosJerN5.aspx.cs" Inherits="KeytiaWeb.UserInterface.RepSevenEleven.RepCencosJerN5" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    ...
    <script type="text/javascript" src="JS/RepCencosJerN5.js"></script>
                        ...
                        <div class="portlet solid bordered">
                            ...
                            <div class="portlet-body" id="divContenedor">
                                <div class="collapse in form-horizontal" id="RepDetallCollapse" role="form">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12" id="detalle5">
                                            <div class="panel panel-default">
                                                ...
                                                <div class="panel-body">
                                                    <div id="ConsumoCencosN5" style="height: 420px;"></div>
                                                </div>
                                            </div>
                                        </div>
