...
{
    public partial class RepCencosJerN4 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Page.ClientScript.RegisterStartupScript(this.GetType(), "funcionConsumoCencosN4", "ConsumoCencosN4('JSONConsumoCencosN4');", true);
        }
        #region WeMethod Json
        [WebMethod]
        public static string JSONConsumoCencosN4(string cencosClave4)
        {
            try
            {
                ...
                cencos = cencosClave4;
                string sp = "EXEC [ObtieneConsumoCencosJerN4V2] @Schema = '" + esquema + "', @CenCos = {0}, @Usuar = {1},@Perfil = {2}, @Fechainicio = '{3}', @Fechafin = '{4}'";
                string query = string.Format(sp, cencosClave4, iCodUsuario, iCodPerfil, fechaInicio, fechaFinal);
                ...
                if (dt.Columns.Contains("CodigoTipoDestino"))
                {
                    dt.Columns["CodigoTipoDestino"].ColumnName = "recid";
                }
                #endregion
        ...
        protected void btnExportar_Click(object sender, EventArgs e)
        {
            ...
            string file = excelFile.GeneraArchivoExcel("ReCencosJerN3_" + DateTime.Now.ToString("hhmmss"), fechaInicio, fechaFinal, dt, dt, 1, 3);
            ExportFiles(file);
        }
        ...
        private DataTable GetDataDropDownList(string clave)
        {
            ...
            query = query.Replace("[NOMVISTA]", "[VisHistoricos('Mes','Meses','Español')] WITH(NOLOCK)");
