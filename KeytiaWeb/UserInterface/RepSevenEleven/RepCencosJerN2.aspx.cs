...
{
    public partial class RepCencosJerN2 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Page.ClientScript.RegisterStartupScript(this.GetType(), "funcionConsumoCencosN2", "ConsumoCencosN2('JSONConsumoCencosN2');", true);
        }
        #region WeMethod Json
        [WebMethod]
        public static string JSONConsumoCencosN2(string cencosClave2)
        {
            try
            {
                ...
                string sp = "EXEC [ObtieneConsumoCencosJerN2V2] @Schema = '" + esquema + "', @CenCos = {0}, @Usuar = {1},@Perfil = {2}, @Fechainicio = '{3}', @Fechafin = '{4}'";
                string query = string.Format(sp, cencosClave2, iCodUsuario, iCodPerfil, fechaInicio, fechaFinal);
        ...
        protected void btnExportar_Click(object sender, EventArgs e)
        {
            ...
            string file = excelFile.GeneraArchivoExcel("ReCencosJerN2_" + DateTime.Now.ToString("hhmmss"), fechaInicio, fechaFinal, dt, dt, 1,1);
            ExportFiles(file);
        }
