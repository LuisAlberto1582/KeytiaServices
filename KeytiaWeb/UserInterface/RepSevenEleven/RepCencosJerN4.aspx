<%@ Page Title="" Language="C#" MasterPageFile="~/KeytiaOH.Master" AutoEventWireup="true" CodeBehind="RepCencosJerN4.aspx.cs" Inherits="KeytiaWeb.UserInterface.RepSevenEleven.RepCencosJerN4" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    ...
    <script type="text/javascript" src="JS/RepCencosJerN4.js"></script>
                        ...
                        <div class="portlet solid bordered">
                            ...
                            <div class="portlet-body" id="divContenedor">
                                <div class="collapse in form-horizontal" id="RepDetallCollapse" role="form">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12" id="detalle2">
                                            <div class="panel panel-default">
                                                ...
                                                <div class="panel-body">
                                                    <div id="ConsumoCencosN4" style="height: 400px;"></div>
                                                </div>
                                            </div>
                                        </div>
