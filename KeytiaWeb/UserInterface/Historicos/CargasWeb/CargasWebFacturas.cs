...
Nombre:		    SCB
Fecha:		    20110803
Descripción:	Clase con la lógica para cargar las facturas desde la WEB.
Modificación:	
*/
...
//Botones para cada carga de Facturas
//  Carga de Factura Telmex
//      Botón - Claves : Muestra reporte de Claves Cargo
//      Botón - Claves por Definir 
//      Botón - Números por Identificar 
//  Carga de Factura Telcel
//      Botón - Números por Identificar 
//      Botón - Números Duplicados
//  Carga de Factura Nextel
//      Botón - Números por Identificar 
//  Carga de Factura Movistar
//      Botón - Números por Identificar 
//  Carga de Factura de Equipo de Cómputo
//      Botón - Correos por Identificar
//      Botón - Correos Duplicados
//      Botón - Empleados Factura
//  Carga de Factura Axtel
//      Botón - Números por Identificar 
//      Botón  - Claves por Definir 
//  Carga de Factura Iusacell
//      Botón - Números por Identificar 
//  Carga de Factura Alestra
//      Botón - Números por Identificar 
//  Carga de Factura AT&T
//      Botón - Números por Identificar 
//  Carga de Factura Audio conferencias y Videoconferencias
//      Botón - Correos por Identificar
//  Carga de VP Nets.
//      Botón - No. de Tarjeta por Identificar
//      Botón - Centro de Costos mal asignados

namespace KeytiaWeb.UserInterface
{
    public class CargasWebFacturas : CargasWeb
    {
        ...
        public override void FillAjaxControls(bool lbIncluirFechaFin)
        {
            ...
            psbQuery.AppendLine(" and vchDescripcion like '%Carga%Factura%' ");
