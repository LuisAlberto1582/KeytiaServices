<%@ Page Title="" Language="C#" MasterPageFile="~/KeytiaOH.Master" AutoEventWireup="true"
    CodeBehind="SYOUsuarioIns.aspx.cs" Inherits="KeytiaWeb.UserInterface.SYO.admin.Usuario.SYOUsuarioIns" %>
                        ...
                        <asp:Panel ID="Rep0" runat="server" CssClass="TopCenter divToCenter">
                            ...
                            <table class="DSOGrid" cellspacing="0" rules="all" border="1" id="RepPorSucursalMatGrid"
                                ...
                                <tr class="titulosReportes">
                                    <th colspan="2">
                                        <asp:Label ID="lblTitulo" runat="server">Agregar Usuarios</asp:Label>
                                    </th>
                                </tr>
                                ...
                                <tr class="grvitemStyle">
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtUri" runat="server"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfv_Correo" runat="server" ErrorMessage="*Debe introducir Uri"
                                            ControlToValidate="txtUri" Display="Dynamic" ForeColor="Red" ValidationGroup="vlg1"></asp:RequiredFieldValidator>
                                        <asp:CustomValidator ID="cv_Correo" runat="server" ErrorMessage="*El formato del correo es incorrecto."
                                            ControlToValidate="txtUri" ClientValidationFunction="vermail" Display="Dynamic"
                                            ForeColor="Red" ValidationGroup="vlg1"></asp:CustomValidator>
                                    </td>
                                </tr>
                                <tr class="grvalternateItemStyle">
                                    ...
                                    <td>
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ErrorMessage="*Debe introducir Descripcion"
                                            ControlToValidate="txtDescripcion" Display="Dynamic" ForeColor="Red" ValidationGroup="vlg1"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr class="grvitemStyle">
                                    <td>
                               ...
                               <td>
                                ...
                                <tr class="grvitemStyle">
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtCon" runat="server" MaxLength="100" TextMode="Password"></asp:TextBox>
                                ...
                                <tr class="grvalternateItemStyle">
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtCon2" runat="server" MaxLength="100" TextMode="Password"></asp:TextBox>
