<%@ Page Title="" Language="C#" MasterPageFile="~/KeytiaOH.Master" AutoEventWireup="true"
    CodeBehind="SYOClienteIns.aspx.cs" Inherits="KeytiaWeb.UserInterface.SYO.admin.Cliente.SYOClienteIns" %>
    ...
    <div>
        ...
        <div>
            <asp:Panel ID="pToolBar" runat="server" CssClass="fg-toolbar ui-toolbar ui-widget-header ui-corner-tl ui-corner-tr ui-helper-clearfix ">
                &nbsp;&nbsp;<asp:LinkButton ID="LinkButton1" Text="Regresar" runat="server" PostBackUrl="~/UserInterface/SYO/admin/Cliente/SYOCliente.aspx"
                        ...
                        <asp:Panel ID="Rep0" runat="server" CssClass="TopCenter divToCenter">
                            ...
                            <table class="DSOGrid" cellspacing="0" rules="all" border="1" id="RepPorSucursalMatGrid"
                                ...
                                <tr class="grvitemStyle">
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtClave" runat="server" MaxLength="100"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="*Debe introducir Clave"
                                            ControlToValidate="txtClave" Display="Dynamic" ForeColor="Red" ValidationGroup="vlg1"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                ...
                                <tr class="grvitemStyle">
                                    ...
                                    <td>
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*Debe introducir la ruta del logo"
                                            ControlToValidate="txtClave" Display="Dynamic" ForeColor="Red" ValidationGroup="vlg1"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr class="grvalternateItemStyle">
                                    ...
                                    <td>
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="*Debe introducir la ruta del logo de exportacion"
                                            ControlToValidate="txtDescripcion" Display="Dynamic" ForeColor="Red" ValidationGroup="vlg1"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
