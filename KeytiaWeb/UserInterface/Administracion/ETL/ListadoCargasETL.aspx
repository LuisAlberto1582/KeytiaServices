<%@ Page Title="" Language="C#" MasterPageFile="~/KeytiaOH.Master" AutoEventWireup="true" CodeBehind="ListadoCargasETL.aspx.cs" Inherits="KeytiaWeb.UserInterface.Administracion.ETL.ListadoCargasETL" %>
...
<script type="text/javascript" src="scripts/FilterTable.js"></script>
    <script type="text/javascript">
        function myFunction(value, string) {
            ...
            sessionStorage.setItem('icodCarga', value);
            sessionStorage.setItem('claveCarga', string);
            window.location.replace("AltaETLFacturaTelcel.aspx?param=" + value);
            return false;
        };
    </script>
    <script type="text/javascript">
        function deleteCarga(value, string) {
<%--          var btn = '<%=btnDelete.ClientID%>';
                                                ...
                                                <asp:GridView runat="server" ID="grvListadoCargas"
                                                    ...
                                                    <Columns>
                                                        <%--                                                        <asp:TemplateField HeaderText="Editar">
                                                            <ItemTemplate>
                                                                <asp:ImageButton ID="lnkEditar" runat="server" ImageUrl="~/images/pencilsmall.png" RowIndex='<%# Container.DisplayIndex %>' OnClick="lnkEditar_Click"></asp:ImageButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
