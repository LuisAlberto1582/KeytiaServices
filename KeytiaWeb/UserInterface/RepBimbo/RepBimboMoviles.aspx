<%@ Page Title="" Language="C#" MasterPageFile="~/KeytiaOH.Master" AutoEventWireup="true" CodeBehind="RepBimboMoviles.aspx.cs" Inherits="KeytiaWeb.UserInterface.RepBimbo.RepBimboMoviles" %>
    ...
    <script type="text/javascript">    
        ...
        $(function () {
            ...
            $jQuery2_2('#grid').w2grid({
                ...
                disableCVS: true,
                searches: [
                    { type: 'int', field: 'Extension', caption: 'Linea' },
                    { type: 'int', field: 'NoNomina', caption: 'No.Nomina' },
                    { type: 'text', field: 'NombreCompleto', caption: 'Empleado' },
                    { type: 'int', field: "CodigoEmpleado", caption: 'Codigo Empleado' },
                    { type: 'int', field: "CodigoCentrodeCostos", caption: 'Codigo Centro de Costos' },
                    { type: 'int', field: "CodigoRazonSocial", caption: 'Codigo Razon Social' },
                    ...
                    { type: 'int', field: 'RID', caption: 'RID' }
                    { type: 'int', field: "TopRID", caption: 'TopRID' },
                ],
                columns: cols,
                records: dataDisp
            });
