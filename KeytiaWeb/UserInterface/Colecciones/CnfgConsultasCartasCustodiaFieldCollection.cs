...
{
    public class CnfgConsultasCartasCustodiaFieldCollection : HistoricFieldCollection
    {
        protected int piCodEntidadCartasCust;

        public CnfgConsultasCartasCustodiaFieldCollection()
        {
        }

        public CnfgConsultasCartasCustodiaFieldCollection(WebControl lContainer, int liCodEntidad, int liCodMaestro, Table lTablaAtributos, ValidacionPermisos lValidarPermiso)
            : base(lContainer, liCodEntidad, liCodMaestro, lTablaAtributos, lValidarPermiso) { }

        public CnfgConsultasCartasCustodiaFieldCollection(int liCodEntidad, int liCodMaestro)
        ...
        protected override void AgregarSubHistoricos()
        {
            ...
            AgregarSubHistoricField("CartaCust", "Recursos Aceptados", "KeytiaWeb.UserInterface.CnfgConsultasCartaCustodia", "KeytiaWeb.UserInterface.CnfgConsultasCartaCustodiaFieldCollection");
            AgregarSubHistoricField("CartaCust", "Recursos Pendientes", "KeytiaWeb.UserInterface.CnfgConsultasCartaCustodia", "KeytiaWeb.UserInterface.CnfgConsultasCartaCustodiaFieldCollection");
            AgregarSubHistoricField("CartaCust", "Recursos Pendientes por Liberar", "KeytiaWeb.UserInterface.CnfgConsultasCartaCustodia", "KeytiaWeb.UserInterface.CnfgConsultasCartaCustodiaFieldCollection");
        }
