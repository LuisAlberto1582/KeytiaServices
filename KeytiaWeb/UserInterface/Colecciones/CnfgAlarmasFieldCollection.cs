...
{
    public class CnfgAlarmasFieldCollection : HistoricFieldCollection
    {
        public CnfgAlarmasFieldCollection()
        { 
        }

        public CnfgAlarmasFieldCollection(WebControl lContainer, int liCodEntidad, int liCodMaestro, Table lTablaAtributos, ValidacionPermisos lValidarPermiso)
            : base(lContainer, liCodEntidad, liCodMaestro, lTablaAtributos, lValidarPermiso) { }

        public CnfgAlarmasFieldCollection(int liCodEntidad, int liCodMaestro)
            : base(liCodEntidad, liCodMaestro) { }

        protected override void AgregarSubHistoricos()
        {
            int liCodEntidad = (int)DSODataAccess.ExecuteScalar("Select iCodRegistro from Catalogos where iCodCatalogo is null and vchCodigo = 'EjecAlarm' and dtiniVigencia <> dtfinVigencia");
            ...
            AgregarSubHistoricField(liCodEntidad, liCodMaestro, "KeytiaWeb.UserInterface.CnfgAlarmasEdit", "KeytiaWeb.UserInterface.CnfgEjecAlarmasFieldCollection");
        }
