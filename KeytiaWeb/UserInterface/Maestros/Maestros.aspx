<%@ Page Language="C#" MasterPageFile="~/KeytiaOV.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="Maestros.aspx.cs" Inherits="KeytiaWeb.UserInterface.Maestros" %>
...
<asp:Content ID="ctHead" ContentPlaceHolderID="cphHead" runat="server">
    ...
    <script src="Maestros.aspx.js" type="text/javascript"></script>
