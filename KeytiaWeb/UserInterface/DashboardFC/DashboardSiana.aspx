<%@ Page Title="" Language="C#" MasterPageFile="~/KeytiaOH.Master" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="KeytiaWeb.UserInterface.DashboardFC.Dashboard" %>
            ...
            <div class="portlet solid bordered viewDetailPortlet">
                <div class="portlet-title">
                    ...
                    <div class="actions col-md-2 col-sm-2 col-lg-2 col-xs-2">
                        ...
                        <p style="text-align:center;" runat="server" id="LlamPerd" visible="false">
                            <asp:LinkButton ID="btnExortDetallP" runat="server" OnClick="btnExortDetallP_Click" CssClass="exportExcel"><i class="fas fa-file-excel"></i> Llamadas perdidas</asp:LinkButton>                                                    
                        </p>
                    </div>
                </div>
            </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphContent" runat="server">
    ...
    <asp:Panel ID="pnlMainHolder" runat="server">
        ...
        <asp:Panel ID="pnlRow_10" runat="server" CssClass="row">
            <asp:Panel ID="Rep10" runat="server" CssClass="col-md-12 col-sm-12"></asp:Panel>
        </asp:Panel>
    </asp:Panel>
