<%@ Page Title="" Language="C#" MasterPageFile="~/KeytiaOH.Master" AutoEventWireup="true" CodeBehind="DetalladoHospitalesITESM.aspx.cs" Inherits="KeytiaWeb.UserInterface.DashboardFC.DetalladoHospitalesITESM" %>
                ...
                <div class="portlet solid bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject titlePortletKeytia">Detalle llamadas hospitales</span>
                        </div>
                        <div class="actions">
                    ...
                    <div class="portlet-body">
                        <div class="collapse in form-horizontal" id="RepDetallCollapse" role="form">
                            <form name="FR_Busquedas" method="post" class="form-horizontal" role="form">
                                ...
                                <asp:Panel ID="rowHospital" runat="server" CssClass="form-group">
                                    <asp:Label ID="lblHospital" runat="server" CssClass="col-sm-2 control-label">Hospital:</asp:Label>
                                    <div class="col-sm-8">
                                        <asp:DropDownList ID="cboHospital" runat="server" CssClass="form-control">
                                        </asp:DropDownList>
                                    </div>
                                </asp:Panel>
