<%@ Page Language="C#" MasterPageFile="~/KeytiaOH.Master" AutoEventWireup="true"
    CodeBehind="DashboardTop10CCustodia.aspx.cs" Inherits="KeytiaWeb.UserInterface.CCustodia.DashboardTop10CCustodia"
    ...
    <div align="center" style="font-family: Verdana; font-size: 11px; color: #000000">
        ...
        <div align="center">
            ...
            <asp:GridView ID="grvCCustAceptadas" runat="server" AutoGenerateColumns="false" Width="80%"
                ...
                <Columns>
                    <asp:HyperLinkField HeaderText="Folio" DataNavigateUrlFields="Codigo Empleado" DataNavigateUrlFormatString="~/UserInterface/CCustodia/AppCCustodia.aspx?Opc=OpcAppCCustodia&iCodEmple={0}&st=tLaJQx5zLrc=&busq=top10ccust"
                        DataTextField="Folio" />
                    <asp:BoundField DataField="Estatus" HeaderText="Estatus" />
                    <asp:HyperLinkField HeaderText="No. Nomina" DataNavigateUrlFields="Codigo Empleado"
                        DataNavigateUrlFormatString="~/UserInterface/CCustodia/AppCCustodia.aspx?Opc=OpcAppCCustodia&iCodEmple={0}&st=tLaJQx5zLrc=&busq=top10ccust"
