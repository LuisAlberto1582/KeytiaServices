<%@ Page Language="C#" MasterPageFile="~/KeytiaOH.Master" AutoEventWireup="true"
    CodeBehind="BusquedaInventarioDisp.aspx.cs" Inherits="KeytiaWeb.UserInterface.CCustodia.BusquedaInventarioDisp"
    ...
    <asp:Panel ID="pnlResultBusqInventarioGrid" runat="server" HorizontalAlign="Center"
        ...
        <asp:GridView ID="grvResultBusqInventario" runat="server" CellPadding="4" CssClass="GridView"
            ...
            <Columns>
                ...
                <asp:HyperLinkField DataNavigateUrlFields="iCodCatDisp" DataNavigateUrlFormatString="~/UserInterface/CCustodia/AdminInventario.aspx?iCodCatDisp={0}&st=tLaJQx5zLrc="
                    Text="[Modificar]" />
                <asp:HyperLinkField DataNavigateUrlFields="iCodCatDisp" DataNavigateUrlFormatString="~/UserInterface/CCustodia/AdminInventario.aspx?iCodCatDisp={0}&st=dwcjh%2B7jVOVukQvtst5CXQ=="
                    Text="[Borrar]" />
            </Columns>
