...
namespace KeytiaWeb.UserInterface.CCustodia
{
    public partial class AdminInventario : System.Web.UI.Page
    {
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            if (result)
            {
                HttpContext.Current.Response.Redirect("~/UserInterface/CCustodia/BusquedaInventarioDisp.aspx");
            }
            else
            {
                string script;
        ...
        {
            HttpContext.Current.Response.Redirect("~/UserInterface/CCustodia/BusquedaInventarioDisp.aspx?stAI=2");
