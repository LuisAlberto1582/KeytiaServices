<%@ Page Title="" Language="C#" MasterPageFile="~/KeytiaOH.Master" AutoEventWireup="true" CodeBehind="AltaConvenio.aspx.cs" Inherits="KeytiaWeb.InvContratos.Pantallas.Pantallas_AltaConvenio" %>
        ...
        <div class="formulario  col-sm-12 col-lg-12">
            <div class="row">
                <div class="  col-sm-12 col-lg-12">
                    <h3 class="labelsize">Alta de Convenio Modificatorio</h3>
                    <hr />
                </div>
            </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            <asp:Label ID="lblNumeroConvenio" Style="font-weight: bold; color: #58697D;" runat="server" Text="Numero convenio:" CssClass="col-lg-4 control-label"></asp:Label>
                                            <div class="col-lg-6">
                                                <asp:TextBox runat="server" ID="txtNumeroConvenio" CssClass="form-control"></asp:TextBox>
                                            </div>
                                        </div>
                                        <%-- FOLIO --%>
                                        <div class="form-group">
                                        ...
                                        <%-- FOLIO RELACIONADO --%>
                                        <div class="form-group">
                                            <asp:Label ID="lblFolioRelacionado" Style="font-weight: bold; color: #58697D;" runat="server" Text="Folio contrato*:" CssClass="col-lg-4 control-label"></asp:Label>
                                            <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-6">
                                                <asp:TextBox runat="server" ID="txtFolioAnexo" CssClass="form-control"></asp:TextBox>
                                            </div>
                                        </div>
