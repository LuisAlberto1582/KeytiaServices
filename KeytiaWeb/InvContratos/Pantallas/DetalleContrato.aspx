<%@ Page Title="" Language="C#" MasterPageFile="~/KeytiaOH.Master" AutoEventWireup="true" CodeBehind="DetalleContrato.aspx.cs" Inherits="KeytiaWeb.InvContratos.Pantallas.DetalleContrato_aspx" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphContent" runat="server">
    ...
    <asp:Panel ID="pnlMainHolder" runat="server" Width="100%" CssClass="row">
        <div class="formulario col-sm-12">
            ...
            <div class="container col-lg-12" runat="server">
                <div class="row form-inline col-lg-12">
                    <asp:Label ID="lblFolioHead" runat="server" Text="Folio contrato:" CssClass="control-label title-form"></asp:Label>
                ...
                <div style="width: 100%; height: 200px; overflow: auto" class="contenedor">
                    <asp:GridView ID="gvPrevioDetalle" OnRowCommand="gvPrevioDetalle_RowCommand" runat="server" ShowHeader="false" AutoGenerateColumns="false" HeaderStyle-CssClass="tableHeaderStyle" CssClass="table" GridLines="None">
                        <Columns>
                            <asp:TemplateField ControlStyle-Width="20" HeaderStyle-Width="20">
                                <ItemTemplate>
                                    ...
                                    <asp:Panel ID="pnlDetalle" runat="server" Style="display: inline;">
                                        <div class="row">
                                            <div class="col-lg-6 form-inline">
                                                <asp:Label ID="lblFolio" runat="server" Text="Folio:" CssClass="control-label"></asp:Label>
                                                <asp:TextBox ID="txtFolio" runat="server" BorderStyle="None" ReadOnly="true" Enabled="false" BackColor="Transparent" CssClass="form-control"></asp:TextBox>
                                            </div>
                                            <div class="col-lg-6 form-inline">
                                                <asp:Label ID="lblInicio" runat="server" Text="Fecha Ini vigencia:" CssClass="control-label"></asp:Label>
                                                <asp:TextBox ID="txtInicio" runat="server" BorderStyle="None" ReadOnly="true" Enabled="false" BackColor="Transparent" CssClass="form-control"></asp:TextBox>
                                                <asp:TextBox ID="txtIdC" runat="server" BorderStyle="None" ReadOnly="true" Visible="false" Enabled="false" BackColor="Transparent" CssClass="form-control"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-6 form-inline">
                                                <asp:Label ID="lblFolioRelacionado" runat="server" Text="Folio con el cual se relaciona:" CssClass="control-label"></asp:Label>
                                                <asp:TextBox ID="txtFolioRelacionado" runat="server" BorderStyle="None" ReadOnly="true" Enabled="false" BackColor="Transparent" CssClass="form-control"></asp:TextBox>
                                            </div>
                                            <div class="col-lg-6 form-inline">
                                                <asp:Label ID="lblFin" runat="server" Text="Fecha fin vigencia:" CssClass="control-label"></asp:Label>
                                                <asp:TextBox ID="txtFin" runat="server" BorderStyle="None" ReadOnly="true" Enabled="false" BackColor="Transparent" CssClass="form-control"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-6 form-inline">
                                                <asp:Label ID="lblClave" runat="server" Text="Clave:" CssClass="control-label"></asp:Label>
                                                <asp:TextBox ID="txtClave" runat="server" BorderStyle="None" ReadOnly="true" Enabled="false" BackColor="Transparent" CssClass="form-control"></asp:TextBox>
                                            </div>
                                            <div class="col-lg-6 form-inline">
                                                <asp:Label ID="lblFechaSolicitud" runat="server" Text="Fecha de Solicitud:" CssClass="control-label"></asp:Label>
                                                <asp:TextBox ID="txtFechaSolicitud" runat="server" BorderStyle="None" ReadOnly="true" Enabled="false" BackColor="Transparent" CssClass="form-control"></asp:TextBox>
                                            </div>
                                            <%--<asp:HyperLink ID="hlCarga" runat="server" NavigateUrl="~/Pantallas/Default.aspx">Cargar archivos</asp:HyperLink>--%>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-6 form-inline">
                                                <asp:Label ID="lblProveedor" runat="server" Text="Proveedor:" CssClass="control-label"></asp:Label>
                                                <asp:TextBox ID="txtProveedor" runat="server" BorderStyle="None" ReadOnly="true" Enabled="false" BackColor="Transparent" CssClass="form-control"></asp:TextBox>
                                            </div>
                                            <div class="col-lg-6 form-inline">
                                                <asp:Label ID="lblSolicitante" runat="server" Text="Solicitante:" CssClass="control-label"></asp:Label>
                                                <asp:TextBox ID="txtSolicitante" runat="server" BorderStyle="None" ReadOnly="true" Enabled="false" BackColor="Transparent" CssClass="form-control"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-6 form-inline">
                                                <asp:Label ID="lblTipoContrato" runat="server" Text="Tipo de contrato:" CssClass="control-label"></asp:Label>
                                                <asp:TextBox ID="txtTipoContrato" runat="server" BorderStyle="None" ReadOnly="true" Enabled="false" BackColor="Transparent" CssClass="form-control"></asp:TextBox>
                                            </div>
                                            <div class="col-lg-6 form-inline">
                                                <asp:Label ID="lblTipoServicio" runat="server" Text="Tipo de servicio:" CssClass="control-label"></asp:Label>
                                                <asp:TextBox ID="txtTipoServicio" runat="server" BorderStyle="None" ReadOnly="true" Enabled="false" BackColor="Transparent" CssClass="form-control"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-6 form-inline">
                                                <asp:Label ID="lblComprador" runat="server" Text="Comprador:" CssClass="control-label"></asp:Label>
                                                <asp:TextBox ID="txtComprador" runat="server" BorderStyle="None" ReadOnly="true" Enabled="false" BackColor="Transparent" CssClass="form-control"></asp:TextBox>
                                            </div>
                                            <div class="col-lg-6 form-inline">
                                                <asp:Label ID="lblVigencia" runat="server" Text="Vigente:" CssClass="control-label"></asp:Label>
                                                <asp:TextBox ID="txtVigencia" runat="server" BorderStyle="None" ReadOnly="true" Enabled="false" BackColor="Transparent" CssClass="form-control"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-6 form-inline">
                                                <asp:Label ID="lblDescripcion" runat="server" Text="Descripcion:" CssClass="control-label"></asp:Label>
                                                <asp:TextBox ID="txtDescripcion" runat="server" BorderStyle="None" ReadOnly="true" Enabled="false" BackColor="Transparent" CssClass="form-control"></asp:TextBox>
                                            </div>
                                        </div>
                                    </asp:Panel>
                                </ItemTemplate>
                ...
                <div class="form-inline">
                    ...
                    <asp:TextBox ID="txtDescripcion" runat="server" Width="90" Enabled="false" CssClass="form-control" />
                    ...
                    <asp:DropDownList ID="DpMonedaElemCont" DataTextField="vchCodigo" Width="170" DataValueField="Id" runat="server" Font-Size="Larger" AppendDataBoundItems="true" CssClass="form-control">
                        <asp:ListItem Value="0">Moneda..</asp:ListItem>
                    </asp:DropDownList>


                    <asp:LinkButton ID="InsertaElemento" runat="server" CssClass="btn btn-default" OnClick="InsertaElementos"> 
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                    ...
                    <div id="RepCapturaCollapse" class="form-horizontal" role="form">
                        <div class="row">
                            <div class="col-md-12 col-sm-12">
                                <asp:Label ID="lblFolio" runat="server" Text="Detalle Folio: " CssClass="control-label"></asp:Label>
                                <asp:TextBox ID="txtFolioContrato2" runat="server" ReadOnly="true" BorderStyle="None" CssClass="form-control" Width="200"></asp:TextBox>
                            </div>
                        </div>
                        <br />
                ...
                <div class="modal-footer">
                    <asp:Button ID="btnCargar" runat="server" OnClick="btnCargar_Click" Text="Guardar" CssClass="btn btn-keytia-sm" />
