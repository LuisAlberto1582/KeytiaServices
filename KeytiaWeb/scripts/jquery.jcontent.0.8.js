    ...
    $.fn.jContent = function(options) {
        ...
        this.init = function(hndl) {
            ...
            hndl.clone_slide = function(index) {
                ...
                //rrh:var html = "<div style='" + slide.attr("style") + "'>" + slide.html() + "</div>";
                var html = "<div style='" + slide.attr("style") + ";overflow:hidden;'>" + slide.html() + "</div>";
                slide.hide();
                return html;
            };
            ...
            //@rrh:
            hndl.panel.css("height", 3 * options.height).css("width", hndl.slides_div.width());
            hndl.panel.children("div").css("height", hndl.slides_div.height()).css("width", hndl.slides_div.width());
            //@rrh:
