...
var QuickSidebar = function () {
    ...
    var handleQuickSidebarToggler = function () {
        ...
        jQNewLook('.dropdown-quick-sidebar-toggler a, .page-quick-sidebar-toggler, .quick-sidebar-toggler').click(function (e) {
            jQNewLook('body').toggleClass('page-quick-sidebar-open'); 
        });
    };

    // Handles quick sidebar chats
    var handleQuickSidebarChat = function () {
        var wrapper = jQNewLook('.page-quick-sidebar-wrapper');
