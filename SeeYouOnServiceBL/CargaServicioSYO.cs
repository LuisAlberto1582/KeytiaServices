...
namespace SeeYouOnServiceBL
{
    public class CargaServicioSYO
    {
        ...
        //RZ.20131101 Se retiran las instancias al com se utilizaran meotodos de la clase KDBUtil
        ...
        protected virtual void ActualizarEstCarga(string lsEstatus, string lsMaestro)
        {
            ...
            //RZ20131101 Se cambian atributos de fecha incio y fecha fin
            phtTablaEnvio.Add("{FecIniCargaVC}", pdtFecIniCarga);
            phtTablaEnvio.Add("{FecFinCargaVC}", DateTime.Now);
            ...
            //cCargaCom.Carga(Util.Ht2Xml(phtTablaEnvio), "Historicos", "Cargas", lsMaestro, (int)pdrConf["iCodRegistro"], psUsuario);
            //cCargaCom.Carga(Util.Ht2Xml(phtTablaEnvio), "Historicos", "Cargas", lsMaestro, (int)pdrConf["iCodRegistro"], CodUsuarioDB);
            //kdb.Update("Historicos", phtTablaEnvio, (int)pdrConf["iCodRegistro"]);
